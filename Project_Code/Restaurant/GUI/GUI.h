...
private:
	...
	int DrawingItemsCount, cookcount;	//actual no. of items in the drawing list
...
public:
	...
	void PrintAvailable(int N, int G, int V, int cN,int cG,int cV, int t, string* msgs,int amsg, int sN, int sG, int sV) const;
